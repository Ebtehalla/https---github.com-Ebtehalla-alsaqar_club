                  ...
                  children: [
                    ...
                    myExpandedWidget(
                      ...
                      [
                        ...
                        const SizedBox(height: 12),
                        //وثيقة الخطة الاستراتيجيه
                        // Firestore PDF fetching and display
                        StreamBuilder<QuerySnapshot>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (!snapshot.hasData) {
                              return const Text('No PDF files found.');
                            }
                            var pdfDocs = snapshot.data!.docs;
                            return Column(
                              children: pdfDocs.map((doc) {
                                var pdfUrl = doc['downloadURL'];
...
// MyListTile widget remains unchanged
class MyListTile extends StatelessWidget {
  const MyListTile(
      {super.key, required this.title, required this.icon, this.screenName});
  final String title;
...
// myExpandedWidget remains unchanged
Widget myExpandedWidget(
  BuildContext context,
  String title,
  List<Widget> children,
